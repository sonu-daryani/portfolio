...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          'absolute top-1 w-5 h-5 rounded-full theme-toggle-thumb pointer-events-none flex items-center justify-center transition-[left] duration-300 ease-out',
          isDark ? 'left-[calc(100%-22px)]' : 'left-[6px]',
        )}
        aria-hidden
      >
        {isDark ? (
